...
urlpatterns = [
    ...
    path('purchase/add/purchaseditem_update/<int:id>',views.purchaseditem_update,name='purchaseditem_update'),
    path('purchase/add/purchaseditem_delete/<int:id>',views.purchaseditem_delete,name='purchaseditem_delete'),
